/**
 * Mostly taken from https://github.com/nextauthjs/next-auth/pull/11342
 * 
...
export interface FronteggProfile extends Record<string, unknown> {
...
export default function Frontegg<P extends FronteggProfile>(options: OAuthUserConfig<P>): OAuthConfig<P> {
  return {
    ...
    issuer: options.issuer,
    profile(profile) {
      // uncomment to debug and add tokens param above
